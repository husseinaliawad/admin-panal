        ...
        <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-800">
            <div class="p-4 md:p-5 flex gap-x-4">
                ...
                <div class="grow">
                    ...
                    <div class="mt-1 flex items-center gap-x-2">
                        <span class="bg-yellow-500 py-1 px-3 rounded text-white shadow">{{ ucfirst($order->status) }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
                <table class="w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="px-6 py-2 text-left font-semibold">Quantity</th>
                ...
                @foreach ($order_items as $item)
                    ...
                    <tr wire:key="{{$item->id}}">
                        ...
                        <td class="py-4">
                            <span class="px-6 py-2 inline-block w-8">{{ $item->quantity }}</span>
        ...
        <div class="md:w-1/4">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex justify-between mb-2">
                    <span>Subtotal</span>
                    <span>{{ number_format($item->order->grand_total, 2, ',', '.') }} €</span>
                </div>
                <div class="flex justify-between mb-2">
                    <span>Taxes</span>
                    <span>0.00€</span>
                ...
                <div class="flex justify-between mb-2">
                    ...
                    <span class="font-semibold">{{ number_format($item->order->grand_total, 2, ',', '.') }} €</span>
                </div>
