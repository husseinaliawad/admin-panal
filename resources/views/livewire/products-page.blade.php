      ...
      <div class="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
        <div class="flex flex-wrap mb-24 -mx-3">
          <div class="w-full pr-2 lg:w-1/4 lg:block">
            ...
            <input type="checkbox" id="{{$category->slug}}" wire:model="selected_categories"
            ...
            <input type="checkbox" wire:model="selected_brands" id="{{$brand->slug}}" value="{{$brand->id}}" class="w-4 h-4 mr-2">
          ...
          @endforeach
              ...
              <ul>
                <li class="mb-4">
                  <label for="featured" class="flex items-center dark:text-gray-300">
                    <input type="checkbox" id="featured" value="1" wire:model="featured" class="w-4 h-4 mr-2">
                    <span class="text-lg dark:text-gray-400">Featured Products</span>
                  </label>
                </li>
                <li class="mb-4">
                  <label for="on_sale" class="flex items-center dark:text-gray-300">
                    <input type="checkbox" id="on_sale" value="1"  wire:model="on_sale" class="w-4 h-4 mr-2">
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              ...
              <div class="font-semibold">{{ number_format($price_range, 2, ',', '.') }} €

                <input type="range" wire:model="price_range" min="{{ $minPrice }}" max="{{ $maxPrice }}" step="50"
                ...
                {{-- <div>
                  <strong>Aktueller Filter:</strong> {{ number_format($price_range, 2, ',', '.') }} €
                </div> --}}
                </div>
              </div>
          ...
          <div class="w-full px-3 lg:w-3/4">
            ...
            <div class="flex flex-wrap items-center ">
              ...
              <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3"  wire:key="{{$product->id}}">
                ...
                <p class="text-lg ">
                <span class="text-green-600 dark:text-green-600">{{ number_format($product->price, 2, ',', '.') }} €
                </span>
                </p>
                </div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-4 h-4 bi bi-cart3 "
                viewBox="0 0 16 16">
                <path
                d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z">
                </path>
                </svg><span  wire:loading.remove>Add to Cart</span><span wire:loading wire:target='addToCart({{$product->id}})'>Adding.......</span>
                </a>
